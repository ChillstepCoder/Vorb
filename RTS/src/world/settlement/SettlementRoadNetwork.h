...
public:
    ...
    bool tryAddRoadBetweenSectorPoints(entt::entity settlement, DTileCoord sector1Pos, DTileCoord sector2Pos, DTileCoord midPoint, TerrainSurfaceType roadType, ui8 width, SettlementZone zone);
private:
