...
public:
    ...
    static void reserveLinesThreadSafe(ui32 count, int lifeTime = 0, int id = 0);
    ...
    static void drawFilledQuadThreadSafe(const f32v3 origin, const f32v2 dims, color4 color, int lifeTime = 0, int id = 0);
