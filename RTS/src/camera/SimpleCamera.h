...
class SimpleCameraPositionerInterface
{
public:
...
{
public:
    explicit SimpleCamera(SimpleCameraPositionerInterface& positioner)
...
class CameraPositioner_FirstPerson final : public SimpleCameraPositionerInterface
{
public:
