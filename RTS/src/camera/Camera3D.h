...
public:
    ...
    const f32m4& getVPMatrix() const override { return m_viewProjectionMatrix; }
    ...
    const vg::Frustum& getFrustum() const { return m_frustum; }
...
protected:
    ...
    vg::Frustum m_frustum; ///< For frustum culling
};
...
private:
    ...
    f64 m_speed = 0.3; ///< The speed of the Camera3D. 1.0 is the highest
};