...
BuildingBlueprintGenerationContext::BuildingBlueprintGenerationContext(
    ...
    desc(&desc), entrySide(entrySide), flags(flags) {
...
//}
//
//void BuildingBlueprintGenerationContext::cancelReserveTileToPlaceItems(PlaceTileBlueprintItemsHandle& handle) {
...
//}
//
//BuildTileBlueprintHandlePtr BuildingBlueprintGenerationContext::reserveTileToBuild(entt::entity builderEntity, const f32v3& entityPosition) {
...
void BuildingBlueprintGenerationContext::endTileToBuild(BuildTileBlueprintHandle& handle) {
    assert(false);
    //assert(handle.mBlueprint == this);
    //handle.mBlueprint = nullptr;
    //--refCount;
