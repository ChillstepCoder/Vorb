...
void ChunkRenderer::renderTiles(const Camera3D& camera) {
...
void ChunkRenderer::renderGrass(const Camera3D& camera, const f32v3& playerPos)
{
...
void ChunkRenderer::renderBillboards(const Camera3D& camera)
{
...
void ChunkRenderer::renderWorldShadows(const Camera3D& camera, f32 maxDistance) {
