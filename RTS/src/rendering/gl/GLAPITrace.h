...
void GLTracer_glClearNamedFramebufferfv(GLuint framebuffer, GLenum buffer, GLint drawbuffer, GLfloat* value)
{
...
void GLTracer_glClearNamedFramebufferfi(GLuint framebuffer, GLenum buffer, GLint drawBuffer, const GLfloat depth, GLint stencil)
{
	printf("glClearNamedFramebufferfi(" "%u, %s, %f, %i)\n", framebuffer, E2S(buffer), depth, stencil);
	apiHook.glClearNamedFramebufferfi(framebuffer, buffer, drawBuffer, depth, stencil);
	assert(glGetError() == GL_NO_ERROR);
}
