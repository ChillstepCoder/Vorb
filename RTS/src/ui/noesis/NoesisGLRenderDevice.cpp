#include "stdafx.h"
#include "NoesisGLRenderDevice.h"
...
{
public:
    GLTexture(NoesisGLRenderDevice* device_, uint32_t width_, uint32_t height_, uint32_t levels_,
    ...
    NoesisGLRenderDevice* const device;
...
{
public:
    GLRenderTarget(NoesisGLRenderDevice* device_, uint32_t width_, uint32_t height_, GLsizei samples_) :
...
////////////////////////////////////////////////////////////////////////////////////////////////////
NoesisGLRenderDevice::NoesisGLRenderDevice(bool sRGB) : mGLVersion(0), mDefaultVAO(0)
{
    //BindAPI(); // Main application is handling this
    FindExtensions();
    FillCaps(sRGB);
...
////////////////////////////////////////////////////////////////////////////////////////////////////
NoesisGLRenderDevice::~NoesisGLRenderDevice()
{
    if (mDefaultVAO != 0)
    {
...
////////////////////////////////////////////////////////////////////////////////////////////////////
Ptr<Texture> NoesisGLRenderDevice::WrapTexture(GLuint object, uint32_t width, uint32_t height,
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void* NoesisGLRenderDevice::CreatePixelShader(const char* label, uint8_t shader, const char* glsl)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::ClearPixelShaders()
{
    for (const ProgramInfo& program : mCustomShaders)
    {
        DeleteProgram(program.object);
...
////////////////////////////////////////////////////////////////////////////////////////////////////
const DeviceCaps& NoesisGLRenderDevice::GetCaps() const
{
    return mCaps;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
Ptr<RenderTarget> NoesisGLRenderDevice::CreateRenderTarget(const char* label, uint32_t width,
...
////////////////////////////////////////////////////////////////////////////////////////////////////
Ptr<RenderTarget> NoesisGLRenderDevice::CloneRenderTarget(const char* label, RenderTarget* shared_)
{
    NS_LOG_TRACE("CreateRenderTarget '%s'", label);
...
////////////////////////////////////////////////////////////////////////////////////////////////////
Ptr<Texture> NoesisGLRenderDevice::CreateTexture(const char* label, uint32_t width, uint32_t height,
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::UpdateTexture(Texture* texture_, uint32_t level, uint32_t x, uint32_t y,
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::BeginOffscreenRender()
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::EndOffscreenRender()
{
    UnbindObjects();
    GL_POP_DEBUG_GROUP();
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::BeginOnscreenRender()
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::EndOnscreenRender()
{
    UnbindObjects();
    GL_POP_DEBUG_GROUP();
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::SetRenderTarget(RenderTarget* surface)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::BeginTile(RenderTarget*, const Tile& tile)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::EndTile(RenderTarget*)
{
#if GL_QCOM_tiled_rendering
    if (IsSupported(Extension::QCOM_tiled_rendering))
    {
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::ResolveRenderTarget(RenderTarget* surface, const Tile* tiles, uint32_t numTiles)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void* NoesisGLRenderDevice::MapVertices(uint32_t bytes)
{
    return MapBuffer(mDynamicVB, bytes);
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::UnmapVertices()
{
    UnmapBuffer(mDynamicVB);
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void* NoesisGLRenderDevice::MapIndices(uint32_t bytes)
{
    return MapBuffer(mDynamicIB, bytes);
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::UnmapIndices()
{
    UnmapBuffer(mDynamicIB);
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::DrawBatch(const Batch& batch)
{
    ProgramInfo* program;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::DeleteTexture(GLTexture* texture)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::DeleteRenderTarget(GLRenderTarget* surface)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::InvalidateStateCache()
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::UnbindObjects()
{
    V(glBindVertexArray(0));
    mVertexArray = 0;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
NoesisGLRenderDevice::Page* NoesisGLRenderDevice::AllocatePage(PageAllocator& allocator)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
NoesisGLRenderDevice::Page* NoesisGLRenderDevice::AllocatePage(DynamicBuffer& buffer)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::CreateBuffer(DynamicBuffer& buffer, GLenum target, uint32_t size,
    const char* label)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::DestroyBuffer(DynamicBuffer& buffer) const
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::BindBuffer(DynamicBuffer& buffer)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::SetVertexFormat(uint8_t format_, uintptr_t offset)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::DisableClientState() const
{
#if NS_RENDERER_OPENGL
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::EnableVertexAttribArrays(uint32_t state)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void* NoesisGLRenderDevice::MapBuffer(DynamicBuffer& buffer, uint32_t size)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::UnmapBuffer(DynamicBuffer& buffer)
{
    if (!HaveBufferStorage())
    {
        if (HaveMapBufferRange())
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::CreateSamplers()
{
...
#if NS_RENDERER_OPENGL
#include "shaders/Shader.140.vert.h"
#include "shaders/Shader.140.stereo.vert.h"
#include "shaders/Shader.140.frag.h"
#else
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::EnsureVsShader(uint32_t n, bool stereo)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::EnsureProgram(uint32_t n, bool stereo)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::CreatePrograms()
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::CreateVertexFormats()
{
    ...
    V(glBindVertexArray(mDefaultVAO));
    ...
    if (IsSupported(Extension::ARB_vertex_attrib_binding))
    {
        NS_ASSERT(glBindVertexArray != 0);

        for (uint32_t i = 0; i < NS_COUNTOF(mVertexFormats); i++)
        {
            mVertexFormats[i].vao_ib = 0;
            GenVertexArrays(1, &mVertexFormats[i].vao);
            V(glBindVertexArray(mVertexFormats[i].vao));
...
////////////////////////////////////////////////////////////////////////////////////////////////////
GLboolean NoesisGLRenderDevice::HaveMapBufferRange() const
{
    return glMapBufferRange != 0;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
GLvoid* NoesisGLRenderDevice::MapBufferRange(GLenum target, GLintptr offset, GLsizeiptr length,
    GLbitfield access) const
{
    NS_ASSERT(glMapBufferRange != 0);
    GLvoid* ptr;
    V(ptr = glMapBufferRange(target, offset, length, access));
    return ptr;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::UnmapBuffer(GLenum target) const
{
    NS_ASSERT(glUnmapBuffer != 0);
    V(glUnmapBuffer(target));
}

////////////////////////////////////////////////////////////////////////////////////////////////////
GLboolean NoesisGLRenderDevice::HaveBufferStorage() const
{
    return glBufferStorage != 0;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::BufferStorage(GLenum target, GLsizeiptr size, GLbitfield flags)
{
    NS_ASSERT(glBufferStorage != 0);
    V(glBufferStorage(target, size, nullptr, flags));
}

////////////////////////////////////////////////////////////////////////////////////////////////////
GLboolean NoesisGLRenderDevice::HaveVertexArrayObject() const
{
    return glGenVertexArrays != 0;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::GenVertexArrays(GLsizei n, GLuint* arrays) const
{
    NS_ASSERT(glGenVertexArrays != 0);
    V(glGenVertexArrays(n, arrays));
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::BindVertexArray(GLuint name)
{
    NS_ASSERT(glBindVertexArray != 0);
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::DeleteVertexArrays(GLsizei n, const GLuint* arrays) const
{
    NS_ASSERT(glDeleteVertexArrays != 0);
    V(glDeleteVertexArrays(n, arrays));
}

////////////////////////////////////////////////////////////////////////////////////////////////////
GLboolean NoesisGLRenderDevice::IsVertexArray(GLuint array) const
{
    NS_ASSERT(glIsVertexArray != 0);
    return glIsVertexArray(array);
}

////////////////////////////////////////////////////////////////////////////////////////////////////
GLuint NoesisGLRenderDevice::RenderbufferStorage(GLsizei samples, GLenum format, GLsizei width,
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::RenderbufferStorageMultisample(GLenum target, GLsizei samples,
    GLenum internalformat, GLsizei width, GLsizei height) const
{
    NS_ASSERT(samples <= (GLsizei)MaxSamples());

    if (samples == 0 || glRenderbufferStorageMultisample == 0)
    {
    ...
    {
        V(glRenderbufferStorageMultisample(target, samples, internalformat, width, height));
    }
}

////////////////////////////////////////////////////////////////////////////////////////////////////
GLboolean NoesisGLRenderDevice::HaveMultisampledRenderToTexture() const
{
    // TODO: Can we enable this?
    return false/*glFramebufferTexture2DMultisample != 0*/;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::FramebufferTexture2DMultisample(GLenum target, GLenum attachment,
    GLenum textarget, GLuint texture, GLint level, GLsizei samples) const
{
    /* NS_ASSERT(glFramebufferTexture2DMultisample != 0);
     V(glFramebufferTexture2DMultisample(target, attachment, textarget, texture, level, samples));*/
}

////////////////////////////////////////////////////////////////////////////////////////////////////
GLuint NoesisGLRenderDevice::CreateStencil(const char* label, GLsizei width, GLsizei height,
...
////////////////////////////////////////////////////////////////////////////////////////////////////
GLuint NoesisGLRenderDevice::CreateColor(const char* label, GLsizei width, GLsizei height,
    GLsizei samples) const
{
#if NS_RENDERER_OPENGL
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::CreateFBO(const char* label, GLsizei samples, GLuint texture, GLuint stencil,
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::Resolve(GLRenderTarget* target, const Tile* tiles, uint32_t numTiles)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::BindRenderTarget(GLRenderTarget* renderTarget)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::DiscardFramebuffer(GLenum target, GLsizei numAttachments,
    const GLenum* attachments) const
{
    if (glInvalidateFramebuffer != 0)
    {
        V(glInvalidateFramebuffer(target, numAttachments, attachments));
    }
}

////////////////////////////////////////////////////////////////////////////////////////////////////
bool NoesisGLRenderDevice::HaveBlitFramebuffer() const
{
    return glBlitFramebuffer != 0;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::BlitFramebuffer(GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1,
    GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, GLenum filter) const
{
    NS_ASSERT(glBlitFramebuffer != 0);
    V(glBlitFramebuffer(srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1, mask, filter));
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::DeleteFramebuffer(GLuint framebuffer) const
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::DeleteRenderbuffer(GLuint renderbuffer) const
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
bool NoesisGLRenderDevice::HaveBorderClamp() const
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
bool NoesisGLRenderDevice::HaveTexStorage() const
{
    return glTexStorage2D != 0;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
bool NoesisGLRenderDevice::HaveTexRG() const
{
    return IsSupported(Extension::ARB_texture_rg) || IsSupported(Extension::EXT_texture_rg);
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::GetGLFormat(TextureFormat::Enum texFormat, GLenum& internalFormat,
    GLenum& format)
{
    switch (texFormat)
    {
...
////////////////////////////////////////////////////////////////////////////////////////////////////
GLint NoesisGLRenderDevice::GLWrapSMode(SamplerState sampler) const
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
GLint NoesisGLRenderDevice::GLWrapTMode(SamplerState sampler) const
{
    switch (sampler.f.wrapMode)
    {
        case WrapMode::ClampToEdge:
...
////////////////////////////////////////////////////////////////////////////////////////////////////
GLint NoesisGLRenderDevice::GLMinFilter(SamplerState sampler) const
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
GLint NoesisGLRenderDevice::GLMagFilter(SamplerState sampler) const
{
    switch (sampler.f.minmagFilter)
    {
        case MinMagFilter::Nearest:
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::TexStorage2D(GLenum target, GLsizei levels, GLenum internalformat,
    GLsizei width, GLsizei height)
{
    NS_ASSERT(glTexStorage2D != 0);
    V(glTexStorage2D(target, levels, internalformat, width, height));
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::InitTexture(const char* label, GLTexture* texture, GLenum internalFormat,
    GLenum format)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::SetTextureState(GLTexture* texture, SamplerState state)
{
    if (IsSupported(Extension::ARB_sampler_objects))
    {
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::SetTexture(uint32_t unit, GLTexture* texture, SamplerState state)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::SetTextures(const Batch& batch)
{
    if (batch.pattern != 0)
    {
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::ActiveTexture(uint32_t unit)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::BindTexture2D(GLuint texture)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::SetUnpackState()
{
    if (!mUnpackStateSet)
    {
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::TexSubImage2D(GLint level, GLint xOffset, GLint yOffset, GLint width,
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::BindSampler(GLuint sampler)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::DeleteSampler(GLuint sampler) const
{
    NS_ASSERT(glIsSampler(sampler));
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::DeleteTexture(GLuint texture) const
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
GLuint NoesisGLRenderDevice::CompileShader(GLenum type, const char** strings, uint32_t count) const
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::LinkProgram(GLuint vso, GLuint pso, ProgramInfo& p, const char* label)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::BindTextureLocation(GLuint po, const char* name, GLint unit)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::UploadUniforms(ProgramInfo* program, uint32_t index, const UniformData& data)
{
#if GL_VERSION_3_1 || GL_ES_VERSION_3_0 || GL_ARB_uniform_buffer_object
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::UseProgram(GLuint name)
{
    NS_ASSERT(name != 0);
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::DeleteShader(GLuint shader) const
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::DeleteProgram(GLuint program) const
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::BlendEnable()
{
    if (mBlendEnabled != 1)
    {
        V(glEnable(GL_BLEND));
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::BlendDisable()
{
    if (mBlendEnabled != 0)
    {
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::BlendFuncSrcOver()
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::BlendFuncSrcOverMultiply()
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::BlendFuncSrcOverScreen()
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::BlendFuncSrcOverAdditive()
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::StencilEnable()
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::StencilDisable()
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::DepthEnable()
{
    if (mDepthEnabled != 1)
    {
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::DepthDisable()
{
    if (mDepthEnabled != 0)
    {
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::StencilOpKeep(uint8_t stencilRef)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::StencilOpIncr(uint8_t stencilRef)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::StencilOpDecr(uint8_t stencilRef)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::StencilOpClear()
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::SetRenderState(RenderState state, uint8_t stencilRef)
{
    RenderState delta;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::Viewport(uint32_t width, uint32_t height)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::BindAPI()
{
#if NS_RENDERER_USE_WGL
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::DetectGLVersion()
{
    uint32_t major;
    uint32_t minor;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::FindExtensions()
{
#if NS_RENDERER_OPENGL
...
//    //glFramebufferTexture2DMultisample = 0;
...
//        glMapBufferRange = glMapBufferRangeEXT;
...
//        glBlitFramebuffer = glBlitFramebufferANGLE;
//#else
//        NS_ASSERT_UNREACHABLE;
//#endif
//    }
...
//        glRenderbufferStorageMultisample = glRenderbufferStorageMultisampleIMG;
//#else
//        NS_ASSERT_UNREACHABLE;
//#endif
//    }
...
//    {
//#if GL_IMG_multisampled_render_to_texture
//        glFramebufferTexture2DMultisample = glFramebufferTexture2DMultisampleIMG;
//#else
//        NS_ASSERT_UNREACHABLE;
//#endif
//    }
...
////////////////////////////////////////////////////////////////////////////////////////////////////
bool NoesisGLRenderDevice::IsSupported(Extension::Enum extension) const
{
    return mExtensions[extension].supported;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
uint32_t NoesisGLRenderDevice::MaxSamples() const
{
    if (IsSupported(Extension::EXT_multisampled_render_to_texture))
    {
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::FillCaps(bool sRGB)
{
    mCaps.centerPixelOffset = 0.0f;
    mCaps.linearRendering = sRGB;
    mCaps.depthRangeZeroToOne = true;
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::PushDebugGroup(const char* label) const
{
    if (glPushDebugGroup != 0)
    {
        V(glPushDebugGroup(GL_DEBUG_SOURCE_APPLICATION, 0, -1, label));
    }
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::PopDebugGroup() const
{
    if (glPopDebugGroup != 0)
    {
        V(glPopDebugGroup());
    }
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void NoesisGLRenderDevice::ObjectLabel(GLenum id, GLuint name, const char* label, ...) const
{
    if (glObjectLabel != 0)
    {
        char label_[128];
        ...
        V(glObjectLabel(id, name, -1, label_));
    }
}

////////////////////////////////////////////////////////////////////////////////////////////////////
GLint NoesisGLRenderDevice::GetInteger(GLenum name) const
{
    GLint vv;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
GLint NoesisGLRenderDevice::GetInteger(GLenum name, uint32_t i) const
{
    NS_ASSERT(i < 4);
    GLint vv[4];
    V(glGetIntegerv(name, vv));
...
////////////////////////////////////////////////////////////////////////////////////////////////////
GLfloat NoesisGLRenderDevice::GetFloat(GLenum name) const
{
    GLfloat vv;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
GLfloat NoesisGLRenderDevice::GetFloat(GLenum name, uint32_t i) const
{
    NS_ASSERT(i < 4);
    GLfloat vv[4];
    V(glGetFloatv(name, vv));
...
////////////////////////////////////////////////////////////////////////////////////////////////////
GLboolean NoesisGLRenderDevice::GetBoolean(GLenum name, uint32_t i) const
{
    NS_ASSERT(i < 4);
    GLboolean vv[4];
...
////////////////////////////////////////////////////////////////////////////////////////////////////
GLboolean NoesisGLRenderDevice::VertexAttribArrayEnabled(GLuint index) const
{
    GLint vv;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
GLint NoesisGLRenderDevice::GetTexParameter(GLenum name) const
{
    GLint vv;
