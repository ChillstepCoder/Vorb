...
TileEditorPanelResult TileEditorPanel::updateAndRender(float ySize) {
    ...
    TileEditorPanelResult returnValue = std::make_pair(TileEditorPanelResultCode::NONE, TileEditorPanelResultVariant(nullptr));
    ...
    if (ImGui::CollapsingHeader("Models", ImGuiTreeNodeFlags_DefaultOpen)) {
        ...
        const f32 rowMinHeight = 20.0f;
        if (ImGui::BeginTable("table_advanced", 4, flags,  ImVec2(0, 0), 0.0f))
        {
            // Declare columns
