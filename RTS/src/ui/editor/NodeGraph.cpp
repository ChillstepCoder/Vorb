...
#include <extern/imgui-node-editor/utilities/builders.h>
#include <extern/imgui-node-editor/utilities/widgets.h>
...
{
    ed::Config config;
    config.SettingsFile = "TMP_NodeEditorPos.json"; // TODO: Each asset should contain a settings file?
    ...
    m_HeaderBackground = TextureRepository::get().getAssetHandle(CStrToken("blueprint_bb"));
    m_SaveIcon = TextureRepository::get().getAssetHandle(CStrToken("ic_save"));
    m_RestoreIcon = TextureRepository::get().getAssetHandle(CStrToken("ic_restore"));
}
...
void NodeGraph::updateAndRender()
{

    if (!m_HeaderBackground->isLoaded() || !m_RestoreIcon->isLoaded() || !m_SaveIcon->isLoaded()) {
        return;
    }

    const TextureDef& headerBackground = m_HeaderBackground->getLoadedAsset();
    const TextureDef& saveIcon = m_SaveIcon->getLoadedAsset();
    const TextureDef& restoreIcon = m_RestoreIcon->getLoadedAsset();
...
void NodeGraph::ShowStyleEditor(bool* show /*= nullptr*/)
{
...
void NodeGraph::ShowLeftPane(float paneWidth)
{
    ...
    int saveIconWidth = m_SaveIcon->getLoadedAsset().gpuTexture.getDims().x;
    int saveIconHeight = m_SaveIcon->getLoadedAsset().gpuTexture.getDims().y;
    int restoreIconWidth = m_RestoreIcon->getLoadedAsset().gpuTexture.getDims().x;
    int restoreIconHeight = m_RestoreIcon->getLoadedAsset().gpuTexture.getDims().y;
...
# endif
        if (node.SavedState.empty())
        {
            ...
            if (ImGui::IsItemActive())
                drawList->AddImage((ImTextureID)m_SaveIcon->getLoadedAsset().gpuTexture.getHandle(), ImGui::GetItemRectMin(), ImGui::GetItemRectMax(), ImVec2(0, 0), ImVec2(1, 1), IM_COL32(255, 255, 255, 96));
            else if (ImGui::IsItemHovered())
                drawList->AddImage((ImTextureID)m_SaveIcon->getLoadedAsset().gpuTexture.getHandle(), ImGui::GetItemRectMin(), ImGui::GetItemRectMax(), ImVec2(0, 0), ImVec2(1, 1), IM_COL32(255, 255, 255, 255));
            else
                drawList->AddImage((ImTextureID)m_SaveIcon->getLoadedAsset().gpuTexture.getHandle(), ImGui::GetItemRectMin(), ImGui::GetItemRectMax(), ImVec2(0, 0), ImVec2(1, 1), IM_COL32(255, 255, 255, 160));
        }
        else
        {
            ImGui::Dummy(ImVec2((float)saveIconWidth, (float)saveIconHeight));
            drawList->AddImage((ImTextureID)m_SaveIcon->getLoadedAsset().gpuTexture.getHandle(), ImGui::GetItemRectMin(), ImGui::GetItemRectMax(), ImVec2(0, 0), ImVec2(1, 1), IM_COL32(255, 255, 255, 32));
        }
...
# endif
        if (!node.SavedState.empty())
        {
            ...
            if (ImGui::IsItemActive())
                drawList->AddImage((ImTextureID)m_RestoreIcon->getLoadedAsset().gpuTexture.getHandle(), ImGui::GetItemRectMin(), ImGui::GetItemRectMax(), ImVec2(0, 0), ImVec2(1, 1), IM_COL32(255, 255, 255, 96));
            else if (ImGui::IsItemHovered())
                drawList->AddImage((ImTextureID)m_RestoreIcon->getLoadedAsset().gpuTexture.getHandle(), ImGui::GetItemRectMin(), ImGui::GetItemRectMax(), ImVec2(0, 0), ImVec2(1, 1), IM_COL32(255, 255, 255, 255));
            else
                drawList->AddImage((ImTextureID)m_RestoreIcon->getLoadedAsset().gpuTexture.getHandle(), ImGui::GetItemRectMin(), ImGui::GetItemRectMax(), ImVec2(0, 0), ImVec2(1, 1), IM_COL32(255, 255, 255, 160));
        }
        else
        {
            ImGui::Dummy(ImVec2((float)restoreIconWidth, (float)restoreIconHeight));
            drawList->AddImage((ImTextureID)m_RestoreIcon->getLoadedAsset().gpuTexture.getHandle(), ImGui::GetItemRectMin(), ImGui::GetItemRectMax(), ImVec2(0, 0), ImVec2(1, 1), IM_COL32(255, 255, 255, 32));
        }
