...
void DebugTweakerPanel::updateAndRender(World& world, const vg::GBuffer* activeGBuffer, float ySize, float aspectRatio, f32v3 cameraPos)
{
    ...
    if (ImGui::CollapsingHeader("Simulation")) {
        ...
        ImGui::Checkbox("Disable Sim AI", &sDebugOptions.mDisableSimAI);
        ImGui::Checkbox("Disable Full AI", &sDebugOptions.mDisableFullAI);
    }
    ...
    if (ImGui::CollapsingHeader("Animation Debugger")) {
        panic("TELL BEN TO FIX THE ANIMATION DEBUGGER");
        //ImGui::PushID(++ID);
        ...
        //        const ModelDef& modelDef = ModelRepository::get().getLoadedOrUnloadedAsset(playerModel.modelId);
        //        ui32 numActive = 0;
