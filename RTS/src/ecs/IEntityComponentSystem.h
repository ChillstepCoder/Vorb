...
public:
    ...
    virtual entt::entity createEntity(const f32v3& position, const nString& typeName, bool shouldReplicate) = 0;
    // Client only, create an entity with a server entity mapping
    virtual entt::entity createEntityFromSrv(entt::entity srvEntity, const f32v3& position, const nString& typeName) = 0;
    // Client or server
