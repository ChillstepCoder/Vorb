...
struct FishingMinigameFishData {
    ...
    f32v2 mAcceleration = f32v2(1200.0f, 1400.0f); // How quickly the fish accelerates in X and Y
    f32 mFishDrag = 0.03f;
    ...
    f32 mGravity = 200.0f; // Gravity to the top of the circle
    f32 mCenterMagnitism = 100.0f; // Gravity to the center of the circle
