...
struct FishingMinigameFishData {
    ...
    f32 mGravity = 0.05f; // Gravity to the top of the circle
    f32 mCenterMagnitism = 0.025f; // Gravity to the center of the circle
    ...
    f32 mPlayerMaxSpeed = 300.0f;
    f32 mPlayerAcceleration = 800.0f;
