...
public:
    ...
    static void sendCharacterStateMessage(int clientIndex, entt::entity srvEntity, const f32v3& pos, const f32v3& velocity, f32 controlAngle, ui32 mDesiredLocomotionMode);
};
