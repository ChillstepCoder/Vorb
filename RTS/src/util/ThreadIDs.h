...
extern std::thread::id SERVER_THREAD_ID;
...
#define IS_SERVER_THREAD() (std::this_thread::get_id() == SERVER_THREAD_ID)
...
#define ASSERT_SERVER_THREAD() (assert(IS_SERVER_THREAD()))
