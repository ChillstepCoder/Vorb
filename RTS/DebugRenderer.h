...
public:
    ...
    static void drawQuad(const f32v2& origin, const f32v2& dims, color4 color, int lifeTime = 0);
    ...
    static void drawAABB(const f32v2& botLeft, const f32v2& dims, color4 color, int lifeTime = 0);
