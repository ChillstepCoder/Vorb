...
#define EMIT_CAST(TYPE, C_TYPE) \
                ...
                case BasicType::TYPE##_V2: e << C_TYPE##v2(data[0], data[1]); break; \
                case BasicType::TYPE##_V3: e << C_TYPE##v3(data[0], data[1], data[2]); break; \
                case BasicType::TYPE##_V4: e << C_TYPE##v4(data[0], data[1], data[2], data[3]); break
